...
<head>
  ...
  <link rel="shortcut icon" href="/assets/images/background17-h_lvv0kpnz.jpg" type="image/x-icon">
  <meta name="description" content="Support our cause and help us make a difference in the community. Every contribution counts!">
  <title>Buxar Ka Anand</title>
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu2 cid-ubXMn79v6Q" once="menu" id="menu-5-ubXMn79v6Q">
      ...
      <div class="col-12 content-head">
        <div class="mbr-section-head mb-5">
          <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
            <strong>Gallery of Impact</strong>
          </h4>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-6 center mt-2 mb-3">
                <p class="mbr-fonts-style copyright mb-0 display-7">© 2024 Fundraising Heroes. All Rights Reserved.</p>
            </div>
            <div class="col-12 col-lg-6 center">
                <div class="row-links mt-2 mb-3">
                    ...
                    <li class="row-links-soc-item mbr-fonts-style display-7">
                            <a href="#about-me-15-ubXMn7aqnh" class="text-white">Vision</a>
                        </li><li class="row-links-soc-item mbr-fonts-style display-7">
                            <a href="#pricing-cards-1-ubXMn7cGsr" class="text-white">Donate</a>
                        </li><li class="row-links-soc-item mbr-fonts-style display-7">
                            <a href="#follow-us-1-ubXMn7d7KG" class="text-white">Contact</a>
                        </li></ul>
                </div>
            </div>
        </div>
